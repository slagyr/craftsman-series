...
//    Getopts g = new Getopts("a:bc", args);
//
//    PrintStream p = System.out;
//    p.println("argc = " + g.argc());
//    p.println("a seen = " + g.hasOption('a'));
//    p.println("option a arg = " + g.option('a'));
//    p.println("b seen = " + g.hasOption('b'));
//    p.println("c seen = " + g.hasOption('c'));
//    p.println("x seen = " + g.hasOption('x'));
//    p.println("option x arg = " + g.option('x'));
//    p.println("argv(0) = " + g.argv(0));
//  }
