...
public class TestFileCarrier extends TestCase {
  ...
  public void testFileCarrier() throws Exception {
    ...
    assertTrue("file wasn't renamed", writtenFile.exists() == false);
    assertTrue("renamed file doesn't exist", renamedOriginal.exists());
    ...
    assertTrue("files aren't the same.", filesAreTheSame(newFile, renamedOriginal));
